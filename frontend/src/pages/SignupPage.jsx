            ...
            <div className="form-control">
              ...
              <div className="relative mb-4">
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <User className="size-6 text-base-cotnent/40"/>
                </div>
                <input type="text" id="username" className="input input-bordered w-full pl-12" placeholder="Username" onChange={(e) => setFormData({...formData, username: e.target.value})}/>
              </div>
              {/* Email input */}
              <label className="label">
